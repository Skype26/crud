        ...
        <div class="h-screen w-full flex flex-col">
            ...
            <div class="w-full">
                ...
                <div class="flex justify-between items-center">
                    <h1 class="p-10 text-5xl font-bold">Agregar Categoria</h1>
                </div>
                ...
                <div class="bg-white pt-3">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if (!empty($nombre) && !empty($scat)) {
                            $stmt = $enlace->prepare("INSERT INTO tb_categoria (nombre_cat, id_subcat) VALUES (?,?)");
                            $stmt->bind_param("si", $nombre, $scat);
                            $stmt->execute();
                            $stmt->close(); 
                            header("Location: categoria_add.php?success=1");
                            exit;
                        } else {
                            header("Location: categoria_add.php?error=1");
                            exit;
                        }
                    }
