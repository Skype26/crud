            ...
            <div class="w-full">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button class="m-10 bg-green-300 hover:bg-green-400 p-3 rounded-lg cursor-pointer"
                        onclick="document.getElementById('ModalAgregarCliente').classList.toggle('hidden')">
                        Agregar Cliente
                    </button>
                    ...
                    <!-- FONDO -->
                    <div id="ModalAgregarCliente" class="hidden fixed inset-0 bg-black/70 flex items-center z-50">
                        <!-- MODAL -->
                        ...
                        Registro fallido...
                            ...
                            <div class="text-white flex justify-center items-center mt-5">
                                ...
                                <button id="btnCancelar" type="button" class="m-2 bg-red-400 hover:bg-red-300 p-3 rounded-lg cursor-pointer">
                                    Cancelar
                                </button>
                            </div>
                        </form>
                        ...
                        <tbody>
                            ...
                            while ($stmt->fetch()) {
                                ...
                                echo "<td class='flex items-center text-white justify-center'>
                                    <a href='cliente_edit.php?id_cliente=" . $id . "' class='m-2 bg-blue-500 hover:bg-blue-600 p-3 rounded-lg'>
